...
-   Germanic origin: *Stréihallem, Strand, Ferndbedienung* vs. French origin: *Schallimo, Plage, Telecommande*
...
Now plot this in a two-dimensional space. Use green for variants with French origin and blue for variants with Germanic origin. In addition, plot also the values for *age* (young - middle-aged - old) and *competence_french* (low - average - high). dd
